...
public class MailUtils {
    ...
    public static SendGridMailRequest toSendGridMailRequest(final Email email) {
        ...
        val personalizations = List.of(Personalization.builder()
                .to(transformToEmailAddress(email.getTo()))
                .cc(transformToEmailAddress(email.getCc()))
                .bcc(transformToEmailAddress(email.getBcc()))
    ...
    private static Set<EmailAddress> transformToEmailAddress(final Set<String> emails) {
